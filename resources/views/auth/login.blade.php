  ...
  <div class="Modal__content SelectionModal__content">
    <div class="AuthModal">
      <div class="AuthModal__action-login">
        <form class="AuthModal__login-form" method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
          @csrf
          <fieldset class="AuthModal__login-fieldset">
            <legend class="AuthModal__login-legend">Se connecter :</legend>
            <label class="InputField AuthModal__login-input {{ $errors->has('email') ? ' is-invalid' : '' }}">
              <span class="InputField__label">e-mail</span>
              <span class="InputField__input-wrapper">
                <input class="InputField__input AuthModal__login-input" type="email" name="email" label="e-mail"
            ...
            <label
              ...
              <span class="InputField__input-wrapper">
                <input class="InputField__input AuthModal__login-input" type="password" name="password"
                  label="mot de passe" required value="" />
              </span>
              <button type="button" class="InputField__toggle-visibility ">
                <svg width="17" height="17" viewBox="0 0 17 17" fill="none">
                  ...
                  <path d="M8.21 0v1.99M4.145.663l.663 1.825M.498 2.902l1.41 1.41M12.355.663l-.746 1.825" stroke="#fff"
