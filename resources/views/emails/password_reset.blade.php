...
<head>
    ...
    <title>Réinitialisez votre mot de passe pour la collection du Mobilier national</title>


</head>

<body
    style="-webkit-text-size-adjust: none; box-sizing: border-box; color: #FFFFFF; font-family:  'Helvetica Neue',Helvetica,Arial,Verdana,sans-serif; height: 100%; line-height: 1.4; margin: 0; width: 100% !important;"
    bgcolor="#FFFFFF">
    <style type="text/css">
        body {
            width: 100% !important;
    ...
    <span class="preheader"
        style="box-sizing: border-box; display: none !important; font-family: 'Helvetica Neue',Helvetica,Arial,Verdana,sans-serif; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; mso-hide: all; opacity: 0; overflow: hidden; visibility: hidden;">Pour
        réinitialiser votre mot de passe cliquez sur le bouton ci-dessous.</span>
                            ...
                            <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        style="box-sizing: border-box; font-family: 'Helvetica Neue',Helvetica,Arial,Verdana,sans-serif; padding: 0px; word-break: break-word;">
                                        <p class="sub align-center"
                                            style="box-sizing: border-box; color: #767676; font-family: 'Helvetica Neue',Helvetica,Arial,Verdana,sans-serif; font-size: 13px; line-height: 1.5em; margin-top: 0; padding : 0px 0px 0px 35px;"
                                            align="left">
                                            Mobilier national
