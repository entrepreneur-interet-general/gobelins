...
export default class PinchZoomPan extends React.Component {
  ...
  maybeHandleDimensionsChanged() {
    if (this.isImageReady) {
      ...
      if (
        ...
        this.debug(
          `Dimensions changed: Container: ${containerDimensions.width}, ${
  ...
  constrainAndApplyTransform(
    ...
    const transform =
      ...
      requestedTransform;
    this.debug(
      `Applying transform: left ${transform.left}, top ${
        transform.top
...
PinchZoomPan.propTypes = {
  ...
  customZoomButtons: PropTypes.oneOfType([PropTypes.func, PropTypes.element]),
